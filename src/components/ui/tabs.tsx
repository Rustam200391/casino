...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      'inline-flex h-10 items-center justify-between rounded-md bg-transparent p-1 text-muted-foreground mb-2',
      className,
    )}
    {...props}
  />
