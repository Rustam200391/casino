...
export const Icons = {
  ...
  wheellOfFortune: ({ ...props }: LucideProps) => (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="434"
      height="270"
    ...
    >
      <g filter="url(#filter0_f_3056_116010)">
        <path d="M123.589 389.556C216.711 443.32 335.773 411.417 389.537 318.295L391.269 319.295C445.571 225.22 413.32 104.935 319.266 50.6332C225.206 -3.    67249 104.912 28.5296 50.5964 122.608C-3.71971 216.686 28.5108 336.972 122.589 391.288C216.661 445.6 336.938 413.378 391.259 319.313L123.589 389.   556ZM123.589 389.556C30.4674 335.792 -1.43537 216.729 52.3284 123.608C106.092 30.4865 225.162 -1.38836 318.266 52.3652C411.37 106.119 443.29 225.192    389.527 318.313L123.589 389.556Z" stroke="url(#paint0_linear_3056_116010)" stroke-width="4"/>
      </g>
      <defs>
        <filter id="filter0_f_3056_116010" x="0.210938" y="0.247314" width="441.43" height="441.426" filterUnits="userSpaceOnUse"     color-interpolation-filters="sRGB">
          <feFlood flood-opacity="0" result="BackgroundImageFix"/>
          <feBlend mode="normal" in="SourceGraphic" in2="BackgroundImageFix" result="shape"/>
          <feGaussianBlur stdDeviation="12" result="effect1_foregroundBlur_3056_116010"/>
        </filter>
        <linearGradient id="paint0_linear_3056_116010" x1="410.948" y1="170.05" x2="30.9125" y2="271.891" gradientUnits="userSpaceOnUse">
  ...
  miniLogo: ({ ...props }: LucideProps) => {
    <svg
      ...
      {...props}
    >
      <path d="M32.7065 0.132968C32.8568 0.197405 33.0501 0.175926 33.1146 0.111489C33.2005 0.0470511 33.0716 -0.0173864 32.8353 0.00409277C32.5991 0.00409277 32.5346 0.0685303 32.7065 0.132968Z" fill="#E3E3E3" />
      <path d="M29.2123 0.755625C17.2913 3.39756 7.99083 6.38317 3.75943 8.91771C0.838265 10.6575 0.666432 11.6456 3.1795 11.9033C4.74748 12.0752 8.82852 11.753 13.1029 11.1301C17.1624 10.5501 16.9906 10.6146 16.3248 9.81984C14.0694 7.13494 19.1815 3.74123 29.7278 0.948937C32.8852 0.111249 32.606 0.00385284 29.2123 0.755625Z" fill="#E3E3E3" />
      <path d="M26.1954 9.21842C23.8757 9.43322 17.84 10.2494 17.389 10.4213C17.1312 10.5287 17.1742 10.6575 17.6038 11.1945C19.8376 13.8579 14.7256 17.2731 4.39408 20.0654C2.91201 20.452 1.81658 20.7957 1.96693 20.7957C2.26764 20.8172 10.1075 19.0559 12.4488 18.4545C19.3436 16.6502 24.8208 14.803 28.3434 13.0847C31.8874 11.3449 33.2406 10.0346 32.1237 9.43322C31.5223 9.13251 28.4508 9.00363 26.1954 9.21842Z" fill="#E3E3E3" />
      <path d="M0.919036 20.9678C1.04791 21.0107 1.30566 21.0107 1.45602 20.9678C1.58489 20.9033 1.47749 20.8604 1.17679 20.8604C0.876077 20.8604 0.768681 20.9033 0.919036 20.9678Z" fill="#E3E3E3" />
    </svg>
  },
