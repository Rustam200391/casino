...
import RankSystem from '@/components/pages/bonuses/rank-system';
import RankInfoGrid from '@/components/pages/bonuses/rank-info-grid';
    ...
    <MainLayout>
      ...
      <Tabs defaultValue="bonuses" className="w-auto">
        <TabsList className="w-[100%]">
          <TabsTrigger className="w-[33%]" value="bonuses">
            Бонусы
          </TabsTrigger>
          <TabsTrigger className="w-[33%]" value="levels">
            Уровни
          </TabsTrigger>
          <TabsTrigger className="w-[33%]" value="activity">
            Активность
          </TabsTrigger>
        </TabsList>
